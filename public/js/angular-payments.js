      ...
      form.bind('submit', function() {
        ...
        if(form.hasClass('ng-valid')) {
          ...
          $window.Stripe.createToken(_getDataToSend(scope), function() {
            ...
            if (attr.stripeForm.indexOf('.') > 0) {
              var obj = attr.stripeForm.substring(0, attr.stripeForm.indexOf('.'));
              var prop = attr.stripeForm.substring(attr.stripeForm.indexOf('.')+1);
              scope.$apply(function() {
                scope[obj][prop].apply(scope, args);
              });
            } else {
              scope.$apply(function() {
          ...
          if (attr.stripeForm.indexOf('.') > 0) {
            ...
            var prop = attr.stripeForm.substring(attr.stripeForm.indexOf('.')+1);
            scope.$apply(function() {
              scope[obj][prop].apply(scope, [400, {error: 'Invalid form submitted.'}]);
            });
          } else {
            scope.$apply(function() {
